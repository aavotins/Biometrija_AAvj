...
Regresoriem ir jābūt savstarpēji neatkarīgiem - tādiem, kas cits citu (arī kopīgi) nespēj precīzi prognozēt. Citiem vārdiem sakot, to vērtību dispersijām (*variance*) ir jābūt savstarpēji neietekmētām. To var pārbaudīt ar `vif()` (*variance inflation factor*) funkciju, kurā kā argumentu lieto izveidoto regresijas objektu. Ir pieņemts uzskatīt, ka $vif\le4$ nozīmē savstarpēju neatkarību, tomēr modeli var veidot kā prognostisku (ne vairs precīzi skaidrojošu) sistēmu, ja $vif\le10$
