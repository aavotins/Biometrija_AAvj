...
* Konstanta vai ne-konstante variēšana (dispersija)
...
Iespējamību attiecība jeb Odds ratio
$$
...
Lineārā saistība starp sagaidām vidējo vērtību un regresoru (saistības funkcija ir log)
$$
...
Lai gan pH ietekme šajā gadījumā nav būtiska, koeficients pie pH nozīmē, ka palielinoties pH par vienu vienību, sugu skaits mainās exp(0,03887) reizēm jeb 1,039.
