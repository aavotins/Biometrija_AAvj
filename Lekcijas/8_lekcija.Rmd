...
* Katram "tintes" daudzumam ir jābūt nepieciešam, lai uzsvērtu galveno attēla vēstījumu
...
* Veidojot attēlus posteriem un prezentācijām, jāizmanto platākas līnijas, lielāko simboli un teksti
...
* Jāpārliecinās, ka krāsainais attēls skatīts melnbaltā arī ir uztverams
...
* Raksturojot pazīmes vidējo vērtību, vēlams norādīt arī izkliedi raksturojošos rādītājus, piemēram, ticamības intervālu, standartkļūdu vai standartnovirzi (jābūt saprotamam, kas ir norādīts)
...
* Vēlams norādīt reālās p-vērtības, piemēram, p=0,035, nevis p<0,05. Ja p-vērtība ir ļoti maza (p<0,0001), tad labāk rakstīt, p < 0,0001, nevis skaitli ar mīnus pakāpi.
